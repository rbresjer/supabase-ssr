    ...
    describe("use cases", () => {
        ...
        storageKeys.forEach((storageKey) => {
            it(`should set PKCE code verifier correctly (storage key = ${storageKey})`, async () => {
                ...
                let getAllCalls = 0;
                const setCookies = [];
                const supabase = createServerClient("https://project-ref.supabase.co", "anon-key", {
                            ...
                            if (a.endsWith("/token?grant_type=pkce") &&
                                ...
                                return new Response(JSON.stringify({
                                    ...
                                    user: {
                                        ...
                                        // to force chunking
                                        email: Array.from({ length: MAX_CHUNK_SIZE }, () => "x").join("") + "@example.com",
                                    },
                                }), {
                                    status: 200,
                                    headers: {
                            ...
                            return [
                                {
                                    ...
                                    value: "base64-" +
                                        stringToBase64URL(JSON.stringify({
                                            token_type: "bearer",
